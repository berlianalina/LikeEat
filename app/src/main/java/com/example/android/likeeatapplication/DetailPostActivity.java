...
public class DetailPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        value = (TextView) findViewById(R.id.ratingValue);
                ...
                if (mProcessLike) {
                    ...
                    Constant.refUser.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Like like = new Like(id, user.getUserId());
        ...
        databaseLike.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot ds:dataSnapshot.getChildren()) {
                    ...
                    try {
                        if (like.getUsername().equals(mAuth.getCurrentUser().getUid())) {
